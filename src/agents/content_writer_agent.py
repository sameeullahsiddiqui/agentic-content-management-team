...
class ContentWriterAgent(BaseAgent):
    ...
    def _get_writing_styles(self) -> Dict[str, Dict[str, Any]]:
        ...
        return {
            "social_media": {
                ...
                "max_length": 280,
                "features": ["trending_topics", "user_generated_content", "community_building"]
            },
            "blog_article": {
            ...
            "whatsapp_business": {
                ...
                "max_length": 160,
                "features": ["quick_updates", "personal_touch", "instant_communication"]
            }
        }
    ...
    def _load_indian_examples(self) -> Dict[str, List[Dict[str, Any]]]:
        ...
        return {
            "successful_companies": [
                {"name": "Flipkart", "industry": "E-commerce", "story": "Started in Bangalore, became India's leading e-commerce platform", "founded": 2007},
                {"name": "Zomato", "industry": "Food Tech", "story": "From Delhi startup to global food delivery platform", "founded": 2008},
                {"name": "Paytm", "industry": "Fintech", "story": "Revolutionized digital payments in India", "founded": 2010},
                {"name": "Ola", "industry": "Mobility", "story": "Made ride-sharing accessible across Indian cities", "founded": 2010},
                {"name": "BYJU'S", "industry": "Edtech", "story": "Transformed online learning for Indian students", "founded": 2011},
                {"name": "Swiggy", "industry": "Food Delivery", "story": "Bangalore-based food delivery revolution", "founded": 2014},
                {"name": "Freshworks", "industry": "SaaS", "story": "Chennai-based global software success", "founded": 2010}
            ],
            "entrepreneurs": [
                {"name": "Sachin Bansal", "company": "Flipkart", "achievement": "Built India's largest e-commerce platform"},
                {"name": "Deepinder Goyal", "company": "Zomato", "achievement": "Transformed food discovery and delivery"},
                {"name": "Vijay Shekhar Sharma", "company": "Paytm", "achievement": "Pioneered digital payments in India"},
                {"name": "Bhavish Aggarwal", "company": "Ola", "achievement": "Revolutionized urban mobility"},
                {"name": "Byju Raveendran", "company": "BYJU'S", "achievement": "Made quality education accessible"},
                {"name": "Sriharsha Majety", "company": "Swiggy", "achievement": "Redefined food delivery experience"}
            ],
            "market_statistics": [
                {"metric": "Digital Payment Growth", "value": "300% year-over-year", "source": "RBI Data 2024"},
                {"metric": "Internet Users", "value": "750+ million", "source": "TRAI Report 2024"},
                {"metric": "Smartphone Penetration", "value": "85% in urban areas", "source": "GSMA Intelligence"},
                {"metric": "E-commerce Growth", "value": "₹7.5 lakh crore market", "source": "IBEF Report"},
                {"metric": "UPI Transactions", "value": "10+ billion monthly", "source": "NPCI Data"},
                {"metric": "Startup Funding", "value": "$25+ billion in 2024", "source": "VCCEdge Data"}
            ],
            "cultural_references": [
                {"festival": "Diwali", "business_angle": "Festival shopping season, gifting culture, family celebrations"},
                {"festival": "Holi", "business_angle": "Color themes, celebration products, community events"},
                {"festival": "Eid", "business_angle": "Festive wear, food specialties, family gatherings"},
                {"festival": "Ganesh Chaturthi", "business_angle": "Community celebrations, eco-friendly products, regional focus"},
                {"festival": "Durga Puja", "business_angle": "Eastern India focus, cultural events, artistic themes"},
                {"event": "Cricket World Cup", "business_angle": "National unity, sports marketing, viewing parties"},
                {"event": "Bollywood Releases", "business_angle": "Entertainment marketing, celebrity endorsements"},
                {"trend": "Work from Home", "business_angle": "Digital tools, home office setups, productivity"}
            ]
        }
    ...
    def _generate_social_media_campaign(
        ...
        campaign = {
            "instagram_posts": self._create_instagram_posts(business_info, target_audience, regional_focus),
            "facebook_posts": self._create_facebook_posts(business_info, target_audience, regional_focus),
            "linkedin_posts": self._create_linkedin_posts(business_info, target_audience, regional_focus),
            "whatsapp_messages": self._create_whatsapp_messages(business_info, target_audience, regional_focus),
            "hashtag_strategy": self._create_hashtag_strategy(business_info, regional_focus),
            "posting_schedule": self._create_posting_schedule(regional_focus),
            "content_themes": self._suggest_content_themes(business_info, target_audience)
        }
    ...
    def _create_instagram_posts(
        ...
        educational_content = self._create_educational_content(business_info, target_audience)
        posts.append({
            "type": "educational",
        ...
        posts.append({
            ...
            "content": f"""🏘️ Proud to be part of the {', '.join(regional_focus)} community!
                            ...
                            What do you love most about our local {regional_focus[0] if regional_focus else 'area'} community? Share in the comments below! 👇""",
                                        "engagement_tactics": ["Ask community-related questions", "Share local success stories", "Tag local businesses"],
        ...
        posts.append({
            ...
            "content": f"""🎊 {current_festival['greeting']} to all our wonderful customers! 🎊
                        ...
                        Share your {current_festival['name']} celebrations with us using #{current_festival['hashtag']}{business_info.get('name', '').replace(' ', '')}!""",
                                    "engagement_tactics": ["Festival wishes", "Share festival photos", "Community celebration"],
                                    "best_time": f"{current_festival['optimal_posting_time']}"
                                })
        
        # Customer success story (detailed)
        success_story = self._create_detailed_customer_story(business_info, regional_focus)
        posts.append({
            ...
            "content": f"""👨‍👩‍👧‍👦 Customer Spotlight: The {success_story['family_name']} Family Story
                                ...
                                Have a similar story? We'd love to hear from you! Comment below or send us a message. 📩""",
                                            "engagement_tactics": ["Personal stories", "Emotional connection", "Invite story sharing"],
    ...
    def _extract_business_info(self, brief: str) -> Dict[str, Any]:
        ...
        name_patterns = [r"restaurant name:\s*([^,\n]+)", r"business:\s*([^,\n]+)", r"company:\s*([^,\n]+)"]
        ...
        target_age = f"{age_match.group(1)}-{age_match.group(2)}" if age_match else "25-35"
    ...
    def _extract_usp(self, brief_lower: str, usp_number: int) -> str:
        ...
        industry = self._detect_industry(brief_lower)
        industry_usps = usps.get(industry, [
